...
\begin{enumerate}[label=\textbf{NG\arabic*.}]
  ...
  \item \textbf{Gert does not guarantee binary backward compatibility with v1 internal packages.}
    This is a clean-break architecture. The internal Go package structure, private interfaces, and
