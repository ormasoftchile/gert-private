...
\begin{tikzpicture}[node distance=1.0cm and 1.5cm, scale=0.9, transform shape]
  ...
  \node[stepbox, below=1.0cm of arc-rpcserver]     (arc-auditlog)  {Audit Log (JSONL)};

  %% ── Runtime Core sub-components ─────────────────────────────────────────────
  \node[stepbox, below left=1.3cm  and 1.8cm of arc-executor]  (arc-handlers) {Step Handlers};
  \node[stepbox, below right=1.3cm and 1.8cm of arc-executor]  (arc-varstore) {Variable Store};
...
\begin{tikzpicture}[node distance=0.8cm and 1.0cm, scale=0.9, transform shape]
  ...
  \node[stepbox, right=1.2cm of ss-pending]    (ss-executing)    {executing};
  \node[stepbox, right=1.8cm of ss-executing]  (ss-completed)    {completed};

  %% Waiting for input (below executing, loops back)
  \node[stepbox, below=1.3cm of ss-executing]  (ss-waiting) {waiting\_for\_input};
  ...
  \node[stepbox, below=0.8cm of ss-skipped]    (ss-compensating) {compensating};
  ...
  \draw[gertarrow] (ss-executing) to[out=-55, in=175] (ss-compensating);
\end{tikzpicture}
