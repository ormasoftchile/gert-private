...
For , gert uses \textbf{structured YAML policy blocks} embedded in the runbook's
...
\textbf{Rationale for :}
\begin{itemize}
  \item The policy vocabulary is small and closed (six primitives as of ). A full policy
...
\subsection{+: OPA Integration Hooks}
