# gert v2 — Stress-Test Runbook Corpus

These 10 runbooks are the stress-test corpus used to validate the gert v2 schema design.
...
- `schema.yaml` — gert v2 YAML translation
...
> the gert v2 schema could not fully express the intended semantics of the source runbook.
