...
The following subsections define every normative event kind in . Each definition includes the payload schema, emission semantics, and whether the event is required or optional.
