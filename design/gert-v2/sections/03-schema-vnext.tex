...
\textbf{Example: Incident triage form} (4-field questionnaire using the new field types)
...
- step:
    ...
    prompt: |
      Complete the incident triage form. All fields are required.
    fields:
      - name: severity
        type: integer
        label: Severity score (1 = low, 5 = critical)
        required: true
        validation:
          min: 1
          max: 5
