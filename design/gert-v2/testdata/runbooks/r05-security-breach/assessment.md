...
is **not a step type in gert v2** — it is a field-annotation convention (`x-<namespace>:` prefix)
...
state. The correct step type — `type: wait_for_event` — does not yet exist in the gert v2 schema.
