...
\begin{enumerate}[label=\arabic*.]
  ...
  \item \textbf{Schema validation is mandatory.} Every vector file MUST validate against \texttt{design/gert/conformance/schema.json} before any runtime processes vectors from it. A runtime that loads a vector failing schema validation MUST emit a hard error and refuse to execute the vector; silent skip or best-effort parsing is a conformance violation. Schema validation is part of the conformance harness gate, not a runtime feature flag.
