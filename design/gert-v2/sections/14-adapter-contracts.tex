...
The official VS Code extension (\texttt{vscode/} in the repository) is the
reference implementation of the JSON-RPC execution contract (\texttt{exec/v2})
and the WebSocket event stream contract (\texttt{events/v2}).  Adapter authors
should study its implementation for best practices.
