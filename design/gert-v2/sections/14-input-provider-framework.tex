...
\hline
\textbf{Provider} & \textbf{Input Resolution} & \textbf{choice} & \textbf{decision} & \textbf{collector} & \textbf{getOptions} \\
\hline
\texttt{prompt}   & Yes & Yes & Yes & Yes & No  \\
\texttt{env}      & Yes & No  & No  & No  & No  \\
\texttt{file}     & Yes & No  & No  & No  & No  \\
\texttt{workspace}& Yes & No  & No  & No  & No  \\
\hline
\end{tabular}
\end{center}
